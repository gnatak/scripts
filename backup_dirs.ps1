...
rem    zaloha_adresaru.bat "D:\Data" /overwrite
rem
rem  Vytvori pro kazdy primy podadresar archiv:
...
set "BACKUP_OVERWRITE=0"
if /I "%~2"=="/overwrite" set "BACKUP_OVERWRITE=1"
if /I "%~2"=="-overwrite" set "BACKUP_OVERWRITE=1"
if /I "%~2"=="--overwrite" set "BACKUP_OVERWRITE=1"
...
powershell.exe -NoProfile -ExecutionPolicy Bypass -Command ^
  ...
  "  & ([scriptblock]::Create($script)) -Root $env:BACKUP_ROOT -Overwrite:($env:BACKUP_OVERWRITE -eq '1');" ^
  "  exit 0" ^
  "} catch {" ^
